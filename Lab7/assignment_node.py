...
"""
def main():
    #vn = AssignmentNode(variable_node.VariableNode('x', {}), literal_node.LiteralNode(10), {}, '9')
    vn = AssignmentNode(literal_node.LiteralNode(10), literal_node.LiteralNode(10), {}, '9')
    print(vn.emit())
    print(vn.evaluate())
